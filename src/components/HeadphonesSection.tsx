...
/* ---------- 3D Headphones Model ---------- */
const HeadphonesModel = ({ mouseX = 0 }: { mouseX?: number }) => {
  ...
  return (
    <group ref={group}>
      ...
      <mesh position={[0, 1.1, 0]} rotation={[0, 0, 0]}>
        <torusGeometry args={[0.9, 0.08, 16, 48, Math.PI]} />
        <meshPhysicalMaterial color="#1a1a1a" metalness={0.6} roughness={0.2} clearcoat={1} />
      </mesh>
      {/* Padding top */}
      <mesh position={[0, 1.18, 0]} rotation={[0, 0, 0]}>
        <torusGeometry args={[0.9, 0.05, 8, 48, Math.PI]} />
      ...
      <group position={[-0.9, 0.2, 0]}>
        <mesh>
          ...
          <meshPhysicalMaterial color="#111" metalness={0.4} roughness={0.15} clearcoat={1} />
        </mesh>
        {/* Cushion */}
        ...
        <mesh position={[0, 0, -0.13]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <meshPhysicalMaterial color="#1a73e8" emissive="#1a73e8" emissiveIntensity={1.5} metalness={0.8} />
        </mesh>
      </group>
      {/* Right ear cup */}
      <group position={[0.9, 0.2, 0]}>
      ...
      <mesh position={[-0.88, 0.65, 0]}>
        <boxGeometry args={[0.06, 0.6, 0.06]} />
        <meshPhysicalMaterial color="#1a1a1a" metalness={0.7} roughness={0.2} />
      </mesh>
      <mesh position={[0.88, 0.65, 0]}>
        <boxGeometry args={[0.06, 0.6, 0.06]} />
        <meshPhysicalMaterial color="#1a1a1a" metalness={0.7} roughness={0.2} />
    ...
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            <span className="gradient-text">NovaBand</span>
            <br />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            {specs.map((s, i) => (
              <motion.div
                ...
                className="glass rounded-xl p-4 text-center hover-scale"
              >
