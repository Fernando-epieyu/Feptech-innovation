...
/** Stylized smartphone 3D model built from primitives */
const PhoneModel = ({ mouseX = 0, mouseY = 0 }: { mouseX?: number; mouseY?: number }) => {
    ...
    <group ref={groupRef}>
      ...
      <group position={[-0.6, 1.8, -0.18]}>
        <mesh>
          ...
          <meshPhysicalMaterial color="#1f2937" metalness={0.9} roughness={0.1} />
        </mesh>
        {/* Lens */}
        <mesh position={[0, 0, -0.03]}>
          <cylinderGeometry args={[0.18, 0.18, 0.08, 32]} />
          <meshPhysicalMaterial color="#0d1117" metalness={1} roughness={0} clearcoat={1} />
        </mesh>
      </group>
