    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 section-padding pt-32">
        ...
        <div className="flex flex-col justify-center">
          ...
          >
            <span className="gradient-text">Nova X1</span>
            <br />
            <span className="text-foreground">Pro Series</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Ingeniería de precisión. Pantalla AMOLED 6.8" 120Hz. Chip NovaTech A1.
          ...
          >
            <a
              href="#contact"
              className="px-8 py-3.5 rounded-full bg-primary text-primary-foreground font-medium hover-scale animate-pulse-glow"
            >
              Comprar ahora
            </a>
            <a
              href="#specs"
              className="px-8 py-3.5 rounded-full glass text-foreground font-medium hover-scale"
            >
              Especificaciones
            </a>
          </motion.div>
        ...
        >
          <Canvas camera={{ position: [0, 0, 8], fov: 45 }}>
            ...
            <Suspense fallback={null}>
              <PhoneModel mouseX={mouse.x} mouseY={mouse.y} />
